  ...
  <div class="container py-5">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        <h1 class="font-weight-light">OUR STORY</h1>
        <p class="font-italic text-muted mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
      </div>
      <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src="assets/images/mic.png" alt="" class="img-fluid mb-4 mb-lg-0"></div>
    </div>
</div>
    
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px">Live your Dreams</h1>
    <h2>Start your journey to making that change you've always desired.</h2>
  </div>
</div>
  ...
  <div class="container py-5">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
        ...
        <p class="font-italic text-muted mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a href="#" class="btn fc2 px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
    </div>
  </div>
</div>
