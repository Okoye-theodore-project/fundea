    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item "> <a class="nav-link" href="discover.php">Discover<span class="sr-only">(current)</span> </a>
          </li>
          <li class="nav-item"> <a class="nav-link" href="Campaign.php" >Start a Campaign</a> </li>
